...
import com.sgq.shortlink.project.config.GotoDomainWhiteListConfiguration;
...
import com.sgq.shortlink.project.dto.req.ShortLinkBatchCreateReqDTO;
...
import com.sgq.shortlink.project.dto.req.ShortLinkUpdateReqDTO;
import com.sgq.shortlink.project.dto.resp.*;
import com.sgq.shortlink.project.mq.producer.DelayShortLinkStatsProducer;
import com.sgq.shortlink.project.service.LinkStatsTodayService;
import com.sgq.shortlink.project.service.ShortLinkService;
import com.sgq.shortlink.project.toolkit.HashUtil;
import com.sgq.shortlink.project.toolkit.LinkUtil;
...
import static com.sgq.shortlink.project.common.constant.RedisKeyConstant.*;
    ...
    public void updateShortLink(ShortLinkUpdateReqDTO requestParam) {
        ...
        if (Objects.equals(hasShortLinkDO.getGid(), requestParam.getGid())) {
            LambdaUpdateWrapper<ShortLinkDO> updateWrapper = Wrappers.lambdaUpdate(ShortLinkDO.class)
                    ...
                    .eq(ShortLinkDO::getDelFlag, 0)
                    .eq(ShortLinkDO::getEnableStatus, 0)
                    .set(Objects.equals(requestParam.getValidDateType(), VailDateTypeEnum.PERMANENT.getType()), ShortLinkDO::getValidDateType, null);
            ShortLinkDO shortLinkDO = ShortLinkDO.builder()
