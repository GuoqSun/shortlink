package com.sgq.shortlink.admin.test;

public class UserTableShardingTest {
    public static final String SQL = "CREATE TABLE `t_link_%d` (\n" +
            "  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',\n" +
            "  `domain` varchar(128) DEFAULT NULL COMMENT '域名',\n" +
            "  `short_uri` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '短链接',\n" +
            ...
            ") ENGINE=InnoDB AUTO_INCREMENT=1759134741133819907 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;";
